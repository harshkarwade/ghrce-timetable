...
export default function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-gray-950 text-white overflow-hidden">
      {/* Sidebar */}
      <aside className={`${collapsed ? "w-16" : "w-60"} flex-shrink-0 bg-gray-900 border-r border-gray-700/50 flex flex-col transition-all duration-300`}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-gray-950/90 backdrop-blur border-b border-gray-700/50 px-6 py-3 flex items-center justify-between flex-shrink-0">
